...
[![**Cartouche**](`r here::here('notebook', 'images/old.jpg')`){width=30% height=30%}](https://en.wikipedia.org/wiki/Cartouche){target=_blank}  
...
```{r changes_in_data_collection, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='How we collect Data'}
DiagrammeR::grViz("
...
![[Schema Element Declaration](https://www.w3.org/2009/XMLSchema/XMLSchema.xsd){target="_blank" style="border-color: #cecece;border-style: solid;font-size: large;border-width: thin;padding: 5px;"}](`r paste0(here::here(),'/notebook/images/XMLSchemaDiagram.png')`){style="display: block;margin-left: auto;margin-right: auto;"}
</div>  
...
![[From W3C website](https://www.w3.org/TR/2004/REC-xmlschema-2-20041028/datatypes.html#built-in-datatypes){target="_blank" style="border-color: #cecece;border-style: solid;font-size: large;border-width: thin;padding: 5px;"}](`r paste0(here::here(),"/notebook/images/type-hierarchy.gif")`){style="display: block;margin-left: auto;margin-right: auto;"}
</div>  
...
<div>
<center>
![Simple Type](`r here::here('notebook', 'images/simpleLinkType.png')`)
</center>
...
<div>
<center>
![Extended Type](`r here::here('notebook', 'images/extendedLinkElement.png')`)
</center>
<p style="text-align:center">
...
list(
  ...
  knitr::kable('html') %>% kableExtra::kable_classic_2(full_width = F) %>% 
  htmltools::HTML() %>% 
...
<div>
<center>
![XBRL Type](`r here::here('notebook', 'images/xbrlElement.jpg')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Context Type](`r here::here('notebook', 'images/contextElement.jpg')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Unit Type](`r here::here('notebook', 'images/unitElement.jpg')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Linkbase Overview](`r here::here('notebook', 'images/linksOverView.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Linkbase Schema reference](`r here::here('notebook', 'images/linkbase.png')`)
</center>
<p style="text-align:center">
...
![linkbase element](`r here::here('notebook', 'images/linkbaseElement.jpg')`)
</center>
<p style="text-align:center">
**linkbase element**
</p>
...
<div>
<center>
![Linkbase](`r here::here('notebook', 'images/links.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Presentation Link Diagram](`r here::here('notebook', 'images/presentationlink.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Arelle Validation Options](`r here::here('notebook', 'images/arelleDSValidation.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Four processing models effects](`r here::here('notebook', 'images/processing-models.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Examples for each processing model](`r here::here('notebook', 'images/processing-model-examples.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Table Models](`r here::here('notebook', 'images/table-models.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Table Definition Model](`r here::here('notebook', 'images/definition-model.png')`)
</center>
<p style="text-align:center">
...
<div>
<center>
![Inline XBRL](`r here::here('notebook', 'images/inlineXBRL.png')`)
</center>
<p style="text-align:center">
**Inline XBRL**
</p>
...
<div>
<center>
![Inline XBRL Transformations](`r here::here('notebook', 'images/arelleTransform.png')`)
</center>
<p style="text-align:center">
**Inline XBRL Transformations**
</p>
